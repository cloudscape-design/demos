...
import articleImage from '../commons/article-image.png';
import authorAvatar from '../commons/avatar-b.png';
import { InfoLink, TableEmptyState } from '../commons/common-components';
import DataProvider from '../commons/data-provider';
import { useAsyncData } from '../commons/use-async-data';
import { codeSnippets } from './details-code-snippets';
import { BEHAVIORS_COLUMN_DEFINITIONS, ORIGINS_COLUMN_DEFINITIONS, TAGS_COLUMN_DEFINITIONS } from './details-config';
    ...
    <SpaceBetween size="l">
      ...
      >
        <SpaceBetween size="m" direction="horizontal">
          <div>
            <img width="76" height="76" src={authorAvatar} />
          </div>
          <div>
            <Box variant="p">Rob Andrews</Box>
        ...
        <Button iconName="add-plus">Follow</Button>
      </div>
      <SpaceBetween size="xxs">
        <Link fontSize="heading-m" href="#" variant="primary">
          Tips on building a chef robot
        </Link>
        <Box variant="p">
          AWSome Quiz is an interactive, web-based game designed to test and enhance users' understanding of Amazon Web
          Services (AWS). It features a modern, space-themed interface with an animated starfield background that
          delivers an immersive user experience.
        </Box>
      </SpaceBetween>
      <img width="100%" src={articleImage} />
    </SpaceBetween>
  </Container>
);
...
export const ForYou = () => (
  <Box margin={{ top: 's' }}>
    <SpaceBetween size="xl">
      ...
      <Article />
      <Article />
      <Box margin={{ top: 'm', bottom: 'xxl' }}>
        <Button fullWidth>Show more activity</Button>
      </Box>
    </SpaceBetween>
  </Box>
);
