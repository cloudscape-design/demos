...
export const ToolsContent = () => (
  ...
  >
    <p>
      ...
      You can select instances in bulk by engine or status using the selection dropdown. To drill down even further into
      the details, choose the name of an individual instance.
    </p>
    <p>
