...
import SupportPromptGroup from '@cloudscape-design/chat-components-core/support-prompt-group';
import CodeView from '@cloudscape-design/code-view-components-core/code-view';
import typescriptHighlight from '@cloudscape-design/code-view-components-core/highlight/typescript';
import ActionCard from '@cloudscape-design/components-core/action-card';
import Box from '@cloudscape-design/components-core/box';
import Button from '@cloudscape-design/components-core/button';
import CopyToClipboard from '@cloudscape-design/components-core/copy-to-clipboard';
import ExpandableSection from '@cloudscape-design/components-core/expandable-section';
import FormField from '@cloudscape-design/components-core/form-field';
import Header from '@cloudscape-design/components-core/header';
import Icon from '@cloudscape-design/components-core/icon';
import Input from '@cloudscape-design/components-core/input';
import ItemCard from '@cloudscape-design/components-core/item-card';
import KeyValuePairs from '@cloudscape-design/components-core/key-value-pairs';
import Link from '@cloudscape-design/components-core/link';
import Modal from '@cloudscape-design/components-core/modal';
import Select, { SelectProps } from '@cloudscape-design/components-core/select';
...
import Steps, { StepsProps } from '@cloudscape-design/components-core/steps';
import TextContent from '@cloudscape-design/components-core/text-content';
